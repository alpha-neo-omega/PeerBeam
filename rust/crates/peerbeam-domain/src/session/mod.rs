...
pub use negotiation::{
    ...
    CHAT_FEAT_FILEDECLINE, CHAT_FEAT_FILEREF, CHAT_FEAT_GROUP, CHAT_FEAT_REACTION,
    CHAT_FEAT_RECEIPT, CLIPBOARD_FEAT_CLIP, NOTES_FEAT_SYNC, PIPE_FEAT_STREAM, PRESENCE_FEAT_RING,
    PRESENCE_FEAT_STATUS, SYNC_FEAT_MANIFEST, TRANSFER_FEAT_FOLDER_ACK,
};
